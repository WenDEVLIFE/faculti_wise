...
import { User, Mail, GraduationCap, MapPin, Camera, Pencil } from "lucide-react";
      ...
      <CardContent className="pt-8 space-y-8">
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1 space-y-2 text-center md:text-left">
            <h2 className="text-3xl font-bold text-text font-source-serif">Alex Johnson</h2>
            <p className="text-primary font-semibold">BS Computer Science • 3rd Year</p>
            <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-4">
              <div className="flex items-center gap-2 text-xs text-text-muted bg-surface-alt/50 px-3 py-1.5 rounded-full border border-border/50">
                <Mail className="h-3.5 w-3.5" /> alex.j@student.facultywise.edu
              </div>
              <div className="flex items-center gap-2 text-xs text-text-muted bg-surface-alt/50 px-3 py-1.5 rounded-full border border-border/50">
                <GraduationCap className="h-3.5 w-3.5" /> Student ID: 2022-10452
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 pt-4 border-t border-border/50">
          <div className="space-y-1">
            ...
            <p className="text-sm font-semibold text-text">Computer Science & Engineering</p>
          </div>
          <div className="space-y-1">
            <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Major</p>
            <p className="text-sm font-semibold text-text">Software Engineering</p>
          </div>
          <div className="space-y-1">
            <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Section</p>
            <p className="text-sm font-semibold text-text">BSCS-3A</p>
          </div>
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-1.5 text-sm font-semibold text-text">
              <MapPin className="h-3.5 w-3.5 text-text-muted" /> East Wing, Dorm 4
            </div>
          </div>
        </div>
      </CardContent>
